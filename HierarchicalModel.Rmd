...
ess_beta_mh <- effectiveSize(as.mcmc(beta_eff_mh))
hist(ess_beta_mh, main = "ESS for beta in hierarchical model by MH", xlab = "ESS")
...
ess_beta_pg <- effectiveSize(as.mcmc(beta_eff_pg))
hist(ess_beta_pg, main = "ESS for beta in hierarchical model by PG", xlab = "ESS")
...
ess_beta_jags <- effectiveSize(as.mcmc(beta_eff_jags))
hist(ess_beta_jags, main = "ESS for beta by JAGS", xlab = "ESS")
