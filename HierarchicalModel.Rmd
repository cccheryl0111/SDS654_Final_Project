...
res_hier <- run_mcmc_hier(X, y, id,
                          n_iter = 10000,
                          burn_in = 2000)

res_hier$acc_rate_beta
mean(res_hier$acc_rate_b)

pip_hier <- colMeans(res_hier$Z)
colMeans(res_hier$B)
```
...
res_pg_hier <- run_mcmc_pg_hier(X, y, id,
                                n_iter  = 10000,
                                burn_in = 2000)

colMeans(res_pg_hier$Z)
colMeans(res_pg_hier$B)
```
```{r jags}
model_hier <- "
model {
